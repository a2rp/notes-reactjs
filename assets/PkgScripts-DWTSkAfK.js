import{j as e}from"./index-t22nWg0v.js";import{S as i}from"./styled-O6sRXqp-.js";const r=()=>e.jsxs(i.Page,{children:[e.jsx(i.Title,{children:"PKG Scripts (package.json)"}),e.jsx(i.Lead,{children:"Scripts are short aliases to run common tasks: dev server, build, preview, lint/format, tests, deploy, and utility commands. The same ideas work with npm, pnpm, and yarn."}),e.jsxs(i.Section,{children:[e.jsx(i.H2,{children:"Core scripts"}),e.jsx(i.Pre,{children:`// package.json (scripts only)
{
  "scripts": {
    "dev": "vite",
    "dev:open": "vite --open",
