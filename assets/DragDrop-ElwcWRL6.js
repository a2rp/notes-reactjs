...
}`})]}),e.jsxs(r.Section,{children:[e.jsx(r.H2,{children:"Example: Reorder list (mouse, native DnD)"}),e.jsxs(r.Small,{children:["Beginner-friendly reordering using ",e.jsx("code",{children:"draggable"}),". Also provide buttons for keyboard users (see a11y)."]}),e.jsx(r.Pre,{children:`import React from "react";
