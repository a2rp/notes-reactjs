import{j as e}from"./index-CaPR9t66.js";import{S as t}from"./styled-qdDQy7W7.js";const i=()=>e.jsxs(t.Page,{children:[e.jsx(t.Title,{children:"useState"}),e.jsxs(t.Lead,{children:[e.jsx(t.InlineCode,{children:"useState"})," adds local, reactive state to a function component. It returns a pair: the current value and a ",e.jsx("b",{children:"setter"})," to schedule updates."]}),e.jsxs(t.Section,{children:[e.jsx(t.H2,{children:"Signature & terms"}),e.jsx(t.Pre,{children:`const [state, setState] = useState(initialState);
